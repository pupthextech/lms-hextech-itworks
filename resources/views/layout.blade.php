            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    @if(Auth::user()->role == 'admin')
                        <li class="nav-item @if($active_page == 'adminbooks' || $active_page == 'admingenrebooks') menu-open @endif">
                            <a href="#" class="nav-link @if($active_page == 'adminbooks' || $active_page == 'admingenrebooks') active @endif">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ URL::to('admin/genre/books') }}" class="nav-link @if($active_page == 'admingenrebooks') active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Genres</p>
                                    </a>
                                </li>
