...
@section('content-header')
    <div class="container-fluid">
        ...
        <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="{{ URL::to('admin/books') }}">Book Genres</a></li>
...
<div class="container-fluid">
    <div class="row mb-2 d-flex justify-content-center">
        <div class="col-sm-6">
            <div class="card">
                <form action="{{ route('genre.books.update',$genre->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input type="text" class="form-control" id="name" name="name" placeholder="Romance" value="{{ $genre->name }}">
                        </div>
                    </div>
